//This file contains all the functions that scrape the dining menus
...
/* 	
	Description: Scrapes the dining website to get the URL to the menu(s)
    Inputs: location (String), callback function that handles the menuLinks found
    Outputs: None, (menuLink sent to callback for each menuLink found)
*/
...
/* 	
	Description: Given a location this function scrapes all the menudata available for that location
    Inputs: location (String), callback function that handles the menu data found
    Outputs: None, (menuData sent to callback for each menuLink found)
*/
                        ...
                        $(elem).find('.' + meal).filter(function(i, elem) {
                            ...
                            if (menuItem.find('.chk').length !== 0) {
                                ...
                                var nutritionObject = {
                                    ...
                                    allergens: nutritionArray[24].substring(9).split(',').filter(function(x) {
...
/* 	
	Description: saves a list of foods for a meal to the food/meal databse collections
    Inputs: list of foods, Mongo object Id for meal, location
    Outputs: None
*/
        ...
        Food.findOneAndUpdate({
            ...
            function(err, food) {
                ...
                Meal.findByIdAndUpdate(
                    mealId, { $addToSet: { "foods": food._id } }, {},
                    function(err, meal) {
                        if (err) return console.error(err)
                    }
                );
